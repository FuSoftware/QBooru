...
#include "../../../sources/viewer/Widget/loadingWidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LoadingWidget_t, stringdata) + ofs \
...
void *LoadingWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LoadingWidget.stringdata))

/****************************************************************************
** Meta object code from reading C++ file 'imageTabClass.h'
**
...
#include "../../../sources/viewer/Widget/imageTabClass.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'imageTabClass.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ImageTab_t, stringdata) + ofs \
...
void *ImageTab::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ImageTab.stringdata))
